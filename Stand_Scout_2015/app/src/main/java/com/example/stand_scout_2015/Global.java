...
public  class Global {
	public static String name,robot, startPos = "", team, comment;
	public static int[] stats = new int[30];   //must be corrected later
    public static boolean[] boolStats = new boolean[19], comments = new boolean[20];
