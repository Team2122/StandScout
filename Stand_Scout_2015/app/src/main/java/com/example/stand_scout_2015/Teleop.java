            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.bUndoKnockCont: if (Global.stats[Global.ioTeleKnockCont] > 0)
                                              ...
                                              bKnockCont.setText("Knock Over\nContainer " + Global.stats[Global.ioTeleKnockCont]);
                    break;
                    case R.id.rbLeftTopStack: Global.boolStats[Global.ioLeftTopStack] = !Global.boolStats[Global.ioLeftTopStack];
                                              rbLeftTopStack.setChecked(Global.boolStats[Global.ioLeftTopStack]);
                    break;
                    case R.id.rbMidTopStack: Global.boolStats[Global.ioMidTopStack] = !Global.boolStats[Global.ioMidTopStack];
                                             rbMidTopStack.setChecked(Global.boolStats[Global.ioMidTopStack]);
                    break;
                    case R.id.rbRightTopStack: Global.boolStats[Global.ioRightTopStack] = !Global.boolStats[Global.ioRightTopStack];
                                               rbRightTopStack.setChecked(Global.boolStats[Global.ioRightTopStack]);
                    break;
                    case R.id.rbLeftBottomStack: Global.boolStats[Global.ioLeftBottomStack] = !Global.boolStats[Global.ioLeftBottomStack];
                                                 rbLeftBottomStack.setChecked(Global.boolStats[Global.ioLeftBottomStack]);
                    break;
                    case R.id.rbMidBottomStack: Global.boolStats[Global.ioMidBottomStack] = !Global.boolStats[Global.ioMidBottomStack];
                                                rbMidBottomStack.setChecked(Global.boolStats[Global.ioMidBottomStack]);
                    break;
                    case R.id.rbRightBottomStack: Global.boolStats[Global.ioRightBottomStack] = !Global.boolStats[Global.ioRightBottomStack];
                                                  rbRightBottomStack.setChecked(Global.boolStats[Global.ioRightBottomStack]);
                    break;
