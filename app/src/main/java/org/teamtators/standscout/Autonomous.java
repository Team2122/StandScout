...
public class Autonomous extends Activity {
    ...
    RadioButton rbLeftTote, rbMidTote, rbRightTote, rbLandfill, rbNoShow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbRobSet.setChecked(Global.boolStats[Global.ioRobSet]);
        cbStackedTote.setChecked(Global.boolStats[Global.ioStackedTote]);
        bTote.setText("Tote to\nauto zone " + Global.stats[Global.ioAutoTote]);
        ...
        if (Global.startPos.equals("Left Staging Zone")){
            rbLeftTote.setChecked(true);
        }
        else if (Global.startPos.equals("Middle Staging Zone")){
            rbMidTote.setChecked(true);
        }
        else if (Global.startPos.equals("Right Staging Zone")){
            rbRightTote.setChecked(true);
        }
        else if (Global.startPos.equals("Next to Landfill")){
        ...
        View.OnClickListener listen = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.rbLeftTote: Global.startPos = "Left Staging Zone";
                    ...
                    case R.id.rbMidTote: Global.startPos = "Middle Staging Zone";
                                         ...
                                         rbNoShow.setChecked(false);
                    break;
                    case R.id.rbRightTote: Global.startPos = "Right Staging Zone";
                                           rbMidTote.setChecked(false);
                                           rbLeftTote.setChecked(false);
                                           rbLandfill.setChecked(false);
                                           rbNoShow.setChecked(false);
                    break;
                    case R.id.rbLandfill: Global.startPos = "Next to Landfill";
                                          rbMidTote.setChecked(false);
                                          rbRightTote.setChecked(false);
                                          rbLeftTote.setChecked(false);
                                          rbNoShow.setChecked(false);
                    ...
                    case R.id.rbNoShow: Global.startPos = "Wasn't there";
                                        ...
                                        rbLeftTote.setChecked(false);
                    break;
                    case R.id.bTote:Global.stats[Global.ioAutoTote] += 2;
                    case R.id.bUndoTote:Global.stats[Global.ioAutoTote] -= 1;
                        bTote.setText("Tote to\nauto zone " + Global.stats[Global.ioAutoTote]);
                        break;
                    case R.id.bContainer:Global.stats[Global.ioAutoContainer] += 2;
                    case R.id.bUndoContainer:Global.stats[Global.ioAutoContainer] -= 1;
                        bContainer.setText("Container to\nauto zone " + Global.stats[Global.ioAutoContainer]);
                        break;
                    case R.id.bStepCont:Global.stats[Global.ioAutoStepCont] += 2;
                    case R.id.bUndoStepCont:Global.stats[Global.ioAutoStepCont] -= 1;
                        bStepCont.setText("Container\nfrom step " + Global.stats[Global.ioAutoStepCont]);
                        break;
                    case R.id.bKnockCont:Global.stats[Global.ioAutoKnockCont] += 2;
                    case R.id.bUndoKnockCont:Global.stats[Global.ioAutoKnockCont] -= 1;
                        bKnockCont.setText("Knocked over\nContainer " + Global.stats[Global.ioAutoKnockCont]);
                        break;
    ...
    public void next(){
        if (sTeam.getSelectedItemPosition() == 0){
            ...
            Global.boolStats[Global.ioRobSet] = cbRobSet.isChecked();
            Global.boolStats[Global.ioStackedTote] = cbStackedTote.isChecked();
