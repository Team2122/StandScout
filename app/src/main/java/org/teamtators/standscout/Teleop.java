...
public class Teleop extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbLeftFeed.setChecked(Global.boolStats[Global.ioLeftFeed]);
        cbRightFeed.setChecked(Global.boolStats[Global.ioRightFeed]);
        cbLeftLandfill.setChecked(Global.boolStats[Global.ioLeftLandfill]);
        cbRightLandfill.setChecked(Global.boolStats[Global.ioRightLandfill]);
        rbLeftTopStack.setChecked(Global.boolStats[Global.ioLeftTopStack]);
        rbMidTopStack.setChecked(Global.boolStats[Global.ioMidTopStack]);
        rbRightTopStack.setChecked(Global.boolStats[Global.ioRightTopStack]);
        rbLeftBottomStack.setChecked(Global.boolStats[Global.ioLeftBottomStack]);
        rbMidBottomStack.setChecked(Global.boolStats[Global.ioMidBottomStack]);
        rbRightBottomStack.setChecked(Global.boolStats[Global.ioRightBottomStack]);
        tbLeftStageCont.setChecked(Global.boolStats[Global.ioLeftStageCont]);
        tbMidStageCont.setChecked(Global.boolStats[Global.ioMidStageCont]);
        tbRightStageCont.setChecked(Global.boolStats[Global.ioRightStageCont]);
        tbLeftStepCont.setChecked(Global.boolStats[Global.ioLeftStepCont]);
        tbMidLeftStepCont.setChecked(Global.boolStats[Global.ioMidLeftStepCont]);
        tbMidRightStepCont.setChecked(Global.boolStats[Global.ioMidRightStepCont]);
        tbRightStepCont.setChecked(Global.boolStats[Global.ioRightStepCont]);
        ...
        View.OnClickListener listen = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.b6HighTote:
                        Global.stats[Global.ioTele6HighTote] += 2;
                    case R.id.bUndo6HighTote:
                        Global.stats[Global.ioTele6HighTote] -= 1;
                        b6HighTote.setText("6 high\n" + Global.stats[Global.ioTele6HighTote]);
                        break;
                    case R.id.b5HighTote:
                        Global.stats[Global.ioTele5HighTote] += 2;
                    case R.id.bUndo5HighTote:
                        Global.stats[Global.ioTele5HighTote] -= 1;
                        b5HighTote.setText("5 high\n" + Global.stats[Global.ioTele5HighTote]);
                        break;
                    case R.id.b4HighTote:
                        Global.stats[Global.ioTele4HighTote] += 2;
                    case R.id.bUndo4HighTote:
                        Global.stats[Global.ioTele4HighTote] -= 1;
                        b4HighTote.setText("4 high\n" + Global.stats[Global.ioTele4HighTote]);
                        break;
                    case R.id.b3HighTote:
                        Global.stats[Global.ioTele3HighTote] += 2;
                    case R.id.bUndo3HighTote:
                        Global.stats[Global.ioTele3HighTote] -= 1;
                        b3HighTote.setText("3 high\n" + Global.stats[Global.ioTele3HighTote]);
                        break;
                    case R.id.b2HighTote:
                        Global.stats[Global.ioTele2HighTote] += 2;
                    case R.id.bUndo2HighTote:
                        Global.stats[Global.ioTele2HighTote] -= 1;
                        b2HighTote.setText("2 high\n" + Global.stats[Global.ioTele2HighTote]);
                        break;
                    case R.id.b1HighTote:
                        Global.stats[Global.ioTele1HighTote] += 2;
                    case R.id.bUndo1HighTote:
                        Global.stats[Global.ioTele1HighTote] -= 1;
                        b1HighTote.setText("1 high\n" + Global.stats[Global.ioTele1HighTote]);
                        break;
                    case R.id.b6HighCont:
                        Global.stats[Global.ioTele6HighCont] += 2;
                    case R.id.bUndo6HighCont:
                        Global.stats[Global.ioTele6HighCont] -= 1;
                        b6HighCont.setText("Level 6\n" + Global.stats[Global.ioTele6HighCont]);
                        break;
                    case R.id.b5HighCont:
                        Global.stats[Global.ioTele5HighCont] += 2;
                    case R.id.bUndo5HighCont:
                        Global.stats[Global.ioTele5HighCont] -= 1;
                        b5HighCont.setText("Level 5\n" + Global.stats[Global.ioTele5HighCont]);
                        break;
                    case R.id.b4HighCont:
                        Global.stats[Global.ioTele4HighCont] += 2;
                    case R.id.bUndo4HighCont:
                        Global.stats[Global.ioTele4HighCont] -= 1;
                        b4HighCont.setText("Level 4\n" + Global.stats[Global.ioTele4HighCont]);
                        break;
                    case R.id.b3HighCont:
                        Global.stats[Global.ioTele3HighCont] += 2;
                    case R.id.bUndo3HighCont:
                        Global.stats[Global.ioTele3HighCont] -= 1;
                        b3HighCont.setText("Level 3\n" + Global.stats[Global.ioTele3HighCont]);
                        break;
                    case R.id.b2HighCont:
                        Global.stats[Global.ioTele2HighCont] += 2;
                    case R.id.bUndo2HighCont:
                        Global.stats[Global.ioTele2HighCont] -= 1;
                        b2HighCont.setText("Level 2\n" + Global.stats[Global.ioTele2HighCont]);
                        break;
                    case R.id.b1HighCont:
                        Global.stats[Global.ioTele1HighCont] += 2;
                    case R.id.bUndo1HighCont:
                        Global.stats[Global.ioTele1HighCont] -= 1;
                        b1HighCont.setText("Level 1\n" + Global.stats[Global.ioTele1HighCont]);
                        break;
                    case R.id.b4HighCoopTote:
                        Global.stats[Global.ioTele4HighCoopTote] += 2;
                    case R.id.bUndo4HighCoopTote:
                        Global.stats[Global.ioTele4HighCoopTote] -= 1;
                        b4HighCoopTote.setText("4 high\n" + Global.stats[Global.ioTele4HighCoopTote]);
                        break;
                    case R.id.b3HighCoopTote:
                        Global.stats[Global.ioTele3HighCoopTote] += 2;
                    case R.id.bUndo3HighCoopTote:
                        Global.stats[Global.ioTele3HighCoopTote] -= 1;
                        b3HighCoopTote.setText("3 high\n" + Global.stats[Global.ioTele3HighCoopTote]);
                        break;
                    case R.id.b2HighCoopTote:
                        Global.stats[Global.ioTele2HighCoopTote] += 2;
                    case R.id.bUndo2HighCoopTote:
                        Global.stats[Global.ioTele2HighCoopTote] -= 1;
                        b2HighCoopTote.setText("2 high\n" + Global.stats[Global.ioTele2HighCoopTote]);
                        break;
                    case R.id.b1HighCoopTote:
                        Global.stats[Global.ioTele1HighCoopTote] += 2;
                    case R.id.bUndo1HighCoopTote:
                        Global.stats[Global.ioTele1HighCoopTote] -= 1;
                        b1HighCoopTote.setText("1 high\n" + Global.stats[Global.ioTele1HighCoopTote]);
                        break;
                    case R.id.bLitter:
                        Global.stats[Global.ioTeleLitter] += 2;
                    case R.id.bUndoLitter:
                        Global.stats[Global.ioTeleLitter] -= 1;
                        bLitter.setText("Litter to\nLandfill " + Global.stats[Global.ioTeleLitter]);
                        break;
                    case R.id.bRecycle:
                        Global.stats[Global.ioTeleRecycle] += 2;
                    case R.id.bUndoRecycle:
                        Global.stats[Global.ioTeleRecycle] -= 1;
                        bLitter.setText("Litter in\nContainer " + Global.stats[Global.ioTeleRecycle]);
                        break;
                    case R.id.bKnockStack:
                        Global.stats[Global.ioTeleKnockStack] += 2;
                    case R.id.bUndoKnockStack:
                        Global.stats[Global.ioTeleKnockStack] -= 1;
                        bKnockStack.setText("Knock Over\nStack " + Global.stats[Global.ioTeleKnockStack]);
                        break;
                    case R.id.bKnockCont:
                        Global.stats[Global.ioTeleKnockCont] += 2;
                    case R.id.bUndoKnockCont:
                        Global.stats[Global.ioTeleKnockCont] -= 1;
                        bKnockStack.setText("Knock Over\nContainer " + Global.stats[Global.ioTeleKnockCont]);
                        break;
                    case R.id.rbLeftTopStack:
                        Global.boolStats[Global.ioLeftTopStack] = !Global.boolStats[Global.ioLeftTopStack];
                        rbLeftTopStack.setChecked(Global.boolStats[Global.ioLeftTopStack]);
                        break;
                    case R.id.rbMidTopStack:
                        Global.boolStats[Global.ioMidTopStack] = !Global.boolStats[Global.ioMidTopStack];
                        rbMidTopStack.setChecked(Global.boolStats[Global.ioMidTopStack]);
                        break;
                    case R.id.rbRightTopStack:
                        Global.boolStats[Global.ioRightTopStack] = !Global.boolStats[Global.ioRightTopStack];
                        rbRightTopStack.setChecked(Global.boolStats[Global.ioRightTopStack]);
                        break;
                    case R.id.rbLeftBottomStack:
                        Global.boolStats[Global.ioLeftBottomStack] = !Global.boolStats[Global.ioLeftBottomStack];
                        rbLeftBottomStack.setChecked(Global.boolStats[Global.ioLeftBottomStack]);
                        break;
                    case R.id.rbMidBottomStack:
                        Global.boolStats[Global.ioMidBottomStack] = !Global.boolStats[Global.ioMidBottomStack];
                        rbMidBottomStack.setChecked(Global.boolStats[Global.ioMidBottomStack]);
                        break;
                    case R.id.rbRightBottomStack:
                        Global.boolStats[Global.ioRightBottomStack] = !Global.boolStats[Global.ioRightBottomStack];
                        rbRightBottomStack.setChecked(Global.boolStats[Global.ioRightBottomStack]);
                        break;
                    case R.id.bNext:
                        next();
    ...
    public void back() {
        if (sTeam.getSelectedItemPosition() == 0) {
            ...
            Global.boolStats[Global.ioLeftFeed] = cbLeftFeed.isChecked();
            Global.boolStats[Global.ioRightFeed] = cbRightFeed.isChecked();
            Global.boolStats[Global.ioLeftLandfill] = cbLeftLandfill.isChecked();
            Global.boolStats[Global.ioRightLandfill] = cbRightLandfill.isChecked();
            Global.boolStats[Global.ioLeftStageCont] = tbLeftStageCont.isChecked();
            Global.boolStats[Global.ioMidStageCont] = tbMidStageCont.isChecked();
            Global.boolStats[Global.ioRightStageCont] = tbRightStageCont.isChecked();
            Global.boolStats[Global.ioLeftStepCont] = tbLeftStepCont.isChecked();
            Global.boolStats[Global.ioMidLeftStepCont] = tbMidLeftStepCont.isChecked();
            Global.boolStats[Global.ioMidRightStepCont] = tbMidRightStepCont.isChecked();
            Global.boolStats[Global.ioRightStepCont] = tbRightStepCont.isChecked();
